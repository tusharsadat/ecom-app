                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('allcategory') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-dock-top"></i>
                            <div data-i18n="Account Settings">All Category</div>
                        </a>
                    </li>
                    <li class="menu-header small text-uppercase">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('allsubcategory') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-dock-top"></i>
                            <div data-i18n="Account Settings">All Sub Category</div>
                        </a>
                    </li>
                    <li class="menu-header small text-uppercase">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('allproduct') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-dock-top"></i>
                            <div data-i18n="Account Settings">All Product</div>
                        </a>
                    </li>
                    <li class="menu-header small text-uppercase">
                    ...
                    <li class="menu-item">
                        <a href="" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-dock-top"></i>
                            <div data-i18n="Account Settings">Complete Orders</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="" class="menu-link">
