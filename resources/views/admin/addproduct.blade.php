                ...
                <div class="card-body">
                    <form action="{{ route('storeproduct') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="product_short_des" name="product_short_des"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" cols="30" rows="10" id="product_long_des" name="product_long_des"
